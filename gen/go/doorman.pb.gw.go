...
func request_EntitiesService_Create_0(ctx context.Context, marshaler runtime.Marshaler, client EntitiesServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_EntitiesService_Create_0(ctx context.Context, marshaler runtime.Marshaler, server EntitiesServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EntitiesCreateRequest
	var metadata runtime.ServerMetadata
...
func RegisterEntitiesServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EntitiesServiceServer) error {
	...
	mux.Handle("POST", pattern_EntitiesService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/doorman.EntitiesService/Create", runtime.WithHTTPPathPattern("/user/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EntitiesService_Create_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_EntitiesService_Create_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEntitiesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EntitiesServiceClient) error {
	...
	mux.Handle("POST", pattern_EntitiesService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/doorman.EntitiesService/Create", runtime.WithHTTPPathPattern("/user/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EntitiesService_Create_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_EntitiesService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user", "create"}, ""))
)

var (
	forward_EntitiesService_Create_0 = runtime.ForwardResponseMessage
)
