...
func request_Doorman_Write_0(ctx context.Context, marshaler runtime.Marshaler, client DoormanClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Doorman_Write_0(ctx context.Context, marshaler runtime.Marshaler, server DoormanServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WriteRequest
	var metadata runtime.ServerMetadata
...
func RegisterDoormanHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DoormanServer) error {
	...
	mux.Handle("POST", pattern_Doorman_Write_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/doorman.Doorman/Write", runtime.WithHTTPPathPattern("/write"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Doorman_Write_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Doorman_Write_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDoormanHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DoormanClient) error {
	...
	mux.Handle("POST", pattern_Doorman_Write_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/doorman.Doorman/Write", runtime.WithHTTPPathPattern("/write"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Doorman_Write_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Doorman_Write_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"write"}, ""))

	pattern_Doorman_Check_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"check"}, ""))
)

var (
	forward_Doorman_Write_0 = runtime.ForwardResponseMessage
